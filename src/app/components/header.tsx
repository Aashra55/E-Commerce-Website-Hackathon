    ...
    <header className="shadow-md bg-white tracking-wide relative z-50">
      <section className="flex items-center flex-wrap lg:justify-center gap-4 py-2.5 sm:px-10 px-4 border-gray-200 border-b min-h-[70px]">
        ...
        <div className="lg:absolute lg:right-10 flex items-center ml-auto space-x-8">
          <LanguageSelector />
          <Link href={"/GiftCards"}>
            <BiSolidGift className="cursor-pointer fill-gray-800 hover:fill-orange-600 inline-block text-[24px]" />
          </Link>
          <Link href={"/wishlist"}>
      ...
      <div className="flex flex-wrap justify-center px-10 py-3 relative">
        <div
          id="collapseMenu"
          className={`lg:block max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-2/3 max-lg:min-w-[280px] max-lg:h-full max-lg:bg-white max-lg:shadow-md max-lg:p-4 max-lg:z-50 ${
        ...
        >
          ...
          <ul className="lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[280px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            ...
            <li className="max-lg:border-b max-lg:px-3 max-lg:py-3">
              <a
                href="/"
                className="hover:text-orange-600 hover:fill-orange-600 text-gray-800 text-[15px] flex items-center"
              >
                Home
              </a>
            </li>
